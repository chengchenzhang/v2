...
var app = (function () {
    ...
    /* src/Entry.svelte generated by Svelte v3.44.1 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			p = element("p");
    			t2 = text(/*contents*/ ctx[1]);
    			t3 = space();
    			img = element("img");
    			add_location(h1, file, 8, 1, 129);
    			add_location(p, file, 9, 1, 147);
    			if (!src_url_equal(img.src, img_src_value = /*src*/ ctx[2])) attr_dev(img, "src", img_src_value);
    			add_location(img, file, 10, 1, 168);
    			add_location(main, file, 7, 0, 121);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*contents*/ 2) set_data_dev(t2, /*contents*/ ctx[1]);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let { src } = $$props;
    	const writable_props = ['contents', 'title', 'src'];
    	...
    	$$self.$capture_state = () => ({ contents, title, src });
    	...
    	return [title, contents, src];
    }

    class Entry extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { contents: 1, title: 0, src: 2 });
    		...
    		if (/*contents*/ ctx[1] === undefined && !('contents' in props)) {
    			console.warn("<Entry> was created without expected prop 'contents'");
    		}

    		if (/*src*/ ctx[2] === undefined && !('src' in props)) {
    			console.warn("<Entry> was created without expected prop 'src'");
    		}
    	}
